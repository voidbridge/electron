...
const watchEmbedder = function (embedder) {
  ...
  const destroy = function () {
    for (const guestInstanceId of Object.keys(guestInstances)) {
      // Handle the fact that guest instance might've been destroyed as a side-effect
      if (guestInstances[guestInstanceId] && guestInstances[guestInstanceId].embedder === embedder) {

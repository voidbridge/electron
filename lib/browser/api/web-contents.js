...
// WebContents::sendToFrame(channel, frameUniqueName, args..)
...
WebContents.prototype.sendToFrame = function(channel, frameUniqueName, ...args) {
  if (channel == null) throw new Error('Missing required channel argument')
  if (frameUniqueName == null) throw new Error('Missing required frameUniqueName argument')
  return this._send(false, frameUniqueName, channel, args);
}
